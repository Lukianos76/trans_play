...
class CreateEntityCommand extends Command
{
    ...
    private function createEntityFilesAndDirectories(Filesystem $filesystem, string $entityName, string $lowerEntityName, string $entityPath, string $templatePath): void
    {
        $templates = [
            ...
            'create_handler' => file_get_contents("{$templatePath}/create_handler.tpl.php"),
            'delete_handler' => file_get_contents("{$templatePath}/delete_handler.tpl.php"),
            'update_handler' => file_get_contents("{$templatePath}/update_handler.tpl.php"),
            'get_handler' => file_get_contents("{$templatePath}/get_handler.tpl.php"),
            'get_all_handler' => file_get_contents("{$templatePath}/get_all_handler.tpl.php"),
        ];

        $paths = [
            "{$entityPath}/Application/Controller/{$entityName}Controller.php" => $templates['controller'],
            "{$entityPath}/Application/Handler/Create{$entityName}Handler.php" => $templates['create_handler'],
            "{$entityPath}/Application/Handler/Delete{$entityName}Handler.php" => $templates['delete_handler'],
            "{$entityPath}/Application/Handler/Update{$entityName}Handler.php" => $templates['update_handler'],
            "{$entityPath}/Application/Handler/Get{$entityName}Handler.php" => $templates['get_handler'],
            "{$entityPath}/Application/Handler/GetAll{$entityName}Handler.php" => $templates['get_all_handler'],
